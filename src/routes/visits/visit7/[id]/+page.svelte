<!-- src/routes/visits/visit7/[id]/+page.svelte -->
<script lang="ts">
	import type { PageProps } from './$types';
	import { Calendar, CheckCircle2, ChevronDown, CircleCheck } from '@lucide/svelte';
				...
				{:else}
					...
					>
						...
						<p class="text-xs text-slate-500">
							On clicking the button, Visit 7 will be marked as completed using today’s date. The
							voucher status you selected above will be used, and Visit 8 will be created
						...
						>
							...
							<span>Mark Visit 7 completed</span>
						</button>
					</form>
				{/if}
			</section>
