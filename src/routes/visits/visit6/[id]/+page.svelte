		...
		<div class="space-y-8">
			...
			<section in:fly={{ y: 20, delay: 260, duration: 600 }}>
				<VisitConclusion
					...
					labelVisit="Visit 6"
					nextVisitNumber={7}
					description="By default, Visit 6 will be marked completed with today’s date. You may optionally override the visit date below. Completing this visit will also create Visit 7 as per protocol."
				/>
			</section>
