		...
		<div class="space-y-8">
			...
			<section in:fly={{ y: 20, delay: 210, duration: 600 }}>
				<VisitEfficacyLabs
					bind:visit
					{participant}
					sectionSubtitle="GSH,TNF ALPHA,IL6,SAM-e,SAH,5-methyl cytosine"
				/>
			</section>
			<section in:fly={{ y: 20, delay: 210, duration: 600 }}>
				<!-- TODO: Voucher status -->
			...
			<section in:fly={{ y: 20, delay: 260, duration: 600 }}>
				<VisitConclusion
					...
					labelVisit="Visit 2"
					nextVisitNumber={3}
					description="By default, Visit 2 will be marked completed with today’s date. You may optionally override the visit date below. Completing this visit will also create Visit 3 as per protocol."
				/>
			</section>
		</div>
	</div>
