							...
							<div class="flex items-center justify-between">
								<div class="flex flex-col gap-1.5">
									<h3 class="text-[17px] text-slate-800">
										...
										{/if}
										{#if visit.participant?.randomization_id}
											<span class="ml-2 text-slate-400 font-medium text-[15px]">
												{visit.participant.randomization_id}
											</span>
										{/if}
									</h3>
									...
									<div class="flex items-center gap-4 text-xs font-semibold">
										{#if isOverdue(visit.due_date)}
											...
											<div
												class="flex items-center gap-1.5 bg-red-200 text-red-800 px-2 py-1 rounded-md"
											>
												<svg
								...
								>
									...
									<span
										class="text-3xl font-semibold text-slate-700 leading-none mt-0.5"
									>
										{visit.visit_number}
									</span>
								</div>
